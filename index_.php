...
<html lang="fr">
<head>
    <title>Acrylia — Bijoux en plexiglas</title>
    <meta charset="utf-8">
    ...
    <script src="admin/assets/js/utils.js" defer></script>
    <script src="admin/assets/js/ui.js" defer></script>
    <script src="admin/assets/js/panier.js" defer></script>
    <script src="admin/assets/js/favoris.js" defer></script>
    <script src="admin/assets/js/compte.js" defer></script>
    <script src="admin/assets/js/avis-client.js" defer></script>
    <script src="admin/assets/js/search.js" defer></script>
</head>
<body>
<div id="wrapper">
    ...
    <!-- Modal générique de confirmation (Oui / Annuler), déclenchée par confirmerAction() en JS.
         Remplace les confirm() natifs pour toutes les actions destructives côté client. -->
